#!/usr/bin/env python
'''
This script contains code for applying locally weighted linear regression model (trained using training data)
to test data and estimating MSE
...
plt.title('Locally weighted linreg for test data d=0')
